    ...
    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0">
        <div class="w-full p-10 bg-white rounded-lg shadow md:mt-0 sm:max-w-md">
            ...
            <form class="mt-8 space-y-6" method="post" action="{{ route('login') }}">
                ...
                @endif
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Login name</label>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="/forgotten-password" class="text-sm font-medium text-gray-700 hover:underline">Forgotten password</a>
                </div>

                <button type="submit"
                    class="w-full py-2 font-medium text-center text-white rounded-lg bg-cyan-600 hover:bg-cyan-700">Login</button>

                <div class="flex justify-between">
                    <a href="/registration" class="text-sm font-medium hover:underline text-cyan-600">Registration</a>
                    <a href="/" class="text-sm font-medium text-gray-700 hover:underline">Home</a>
                </div>
            </form>
        </div>
    </div>
