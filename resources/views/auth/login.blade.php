    ...
    <div class="bg-white shadow rounded-lg md:mt-0 w-full sm:max-w-md p-10">
        ...
        <form class="mt-8 space-y-6" action="#">
            ...
            <div class="flex justify-between items-center">
              ...
              <a href="/forgotten-password" class="text-sm font-medium hover:underline text-gray-700">Zabudnuté heslo</a>
            </div>
            
            <button type="submit" class="text-white bg-cyan-600 hover:bg-cyan-700 font-medium rounded-lg py-2 w-full text-center">Prihlásenie</button>
