    ...
    <div class="mx-auto md:h-screen flex flex-col justify-center items-center px-6 pt-8 pt:mt-0">
        <div class="bg-white shadow rounded-lg md:mt-0 w-full sm:max-w-md p-10">
            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
                ...
                @endif
                <div>
                    <label for="username" class="text-sm font-medium text-gray-900 block mb-2">Uživateľské meno<span
                ...
                <div>
                    <label for="password" class="text-sm font-medium text-gray-900 block mb-2">Heslo <span
                            class="text-red-600 text-sm">*</span></label>
                ...
                <button type="submit"
                    class="text-white bg-cyan-600 hover:bg-cyan-700 font-medium rounded-lg py-2 w-full text-center">Zaregistrovať
                    sa</button>

                <div class="flex justify-between">
                    <a href="{{ route('login') }}"
                        class="text-sm font-medium hover:underline text-cyan-600">Prihlásenie</a>
                    <a href="{{ route('dashboard') }}" class="text-sm font-medium hover:underline text-gray-700">Domov</a>
                </div>
            </form>
        </div>
    </div>
