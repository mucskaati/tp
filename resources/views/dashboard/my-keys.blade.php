        ...
        <div class="mt-4 box">
            <div class="bg-white block sm:flex items-center justify-betweenlg:mt-1.5">
                <div class="flex items-center justify-between w-full">
                    <h1 class="text-xl font-semibold text-gray-900">My keys</h1>
                    <a href="{{ route('nomenclator.create') }}" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 sm:w-auto">
            ...
            <div class="flex flex-col mt-5">
                                        ...
                                        @foreach ($keys as $key)
                                            <tr class="hover:bg-gray-100">
                                                <td class="flex items-center gap-4 p-4 whitespace-nowrap">
                                                    {{-- doplnit default img --}}
                                                    @if (isset($key['images']))
                                                        <img src="{{ count($key['images'])? "{$key['images'][0]['url']}": 'https://cryptograms.hcportal.eu/api/uploads/27691600850778.png' }}" alt="thumb" class="w-10 h-10 rounded-full">
                                                    @endif
                                                    <div class="text-sm font-normal text-gray-500">
                                                        <a href="{{ route('nomenclator.show', $key['id']) }}" class="text-base font-semibold text-cyan-600 hover:text-cyan-700">
                                                            {{ $key['signature'] }}
                                                        </a>
                                                        <div class="text-sm font-normal text-gray-500">
                                                            {{ $key['mainUsersString'] }}
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    ...
                    <!-- New key popup -->
                    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="add-user-modal" aria-hidden="true">
