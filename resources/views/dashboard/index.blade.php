        ...
        <div class="mt-4 box">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    ...
                    <!-- Delete verification -->
                    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="delete-user-modal" aria-hidden="true">
