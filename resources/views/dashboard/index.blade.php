...
<div class="container">
    <header class="w-full box-nav p-0">
            <div class="flex flex-col max-w-screen-xl mx-auto md:items-center md:justify-between md:flex-row">
               ...
               <nav class="flex flex-col flex-grow pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
                  <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 text-gray-900 hover:text-blue-800" href="/">Úvod</a>
                  <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 text-gray-900 hover:text-blue-800" href="/">O nás</a>
                  <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 text-gray-900 hover:text-blue-800" href="/admin">Admin</a>
                  <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 text-gray-900 hover:text-blue-800" href="/login">Prihlásenie</a>
               </nav>
            </div>
         </header>
               ...
               <div class="flex items-center justify-between w-full">
                  ...
                  <form action="#" method="GET">
                     ...
                     <div class="mt-1 relative lg:w-64 xl:w-96">
                        <input type="text" name="email" id="users-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Vyhľadať v klúčoch">
                     </div>
                  </form>
                     ...
                     <tbody class="bg-white divide-y divide-gray-200">
                        <tr class="hover:bg-gray-100">
                           <td class="p-4 flex gap-4 items-center whitespace-nowrap">
                              <img src="https://cryptograms.hcportal.eu/api/uploads/27691600850778.png" alt="" class="w-10 h-10 rounded-full">
                              <div class="text-sm font-normal text-gray-500">
                                 <a href="/detail" class="text-base font-semibold text-cyan-600 hover:text-cyan-700">Správa z pohľadnice rok 1903</a>
                        ...
                        <tr class="hover:bg-gray-100">
                           <td class="p-4 flex gap-4 items-center whitespace-nowrap">
                              <img src="https://cryptograms.hcportal.eu/api/uploads/27691600850778.png" alt="" class="w-10 h-10 rounded-full">
                              <div class="text-sm font-normal text-gray-500">
                                 <div class="text-base font-semibold text-cyan-600 hover:text-cyan-700">Správa z pohľadnice rok 1903</div>
                                 <div class="text-sm font-normal text-gray-500">jankomrkvicka@gmail.com</div>
                              </div>
                           </td>
                           <td class="p-4 whitespace-nowrap text-center text-gray-700">Európa</td>
                           <td class="p-4 whitespace-nowrap text-center text-gray-700">20.5.2021</td>
                           <td class="p-4 whitespace-nowrap text-center font-normal text-yellow-500">Na schválenie</td>
                           <td class="p-4 whitespace-nowrap text-center space-x-2">
                              <button type="button" data-modal-toggle="user-modal" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                 <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path>
                        ...
                        <tr class="hover:bg-gray-100">
                           ...
                           <td class="p-4 whitespace-nowrap text-center text-gray-700">Európa</td>
                           <td class="p-4 whitespace-nowrap text-center text-gray-700">20.5.2021</td>
                           <td class="p-4 whitespace-nowrap text-center font-normal text-yellow-500">Na zmenu</td>
                           <td class="p-4 whitespace-nowrap text-center space-x-2">
                              <button type="button" data-modal-toggle="user-modal" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                 <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path>
                        ...
                        <tr class="hover:bg-gray-100">
                           ...
                           <td class="p-4 whitespace-nowrap text-center text-gray-700">Európa</td>
                           <td class="p-4 whitespace-nowrap text-center text-gray-700">20.5.2021</td>
                           <td class="p-4 whitespace-nowrap text-center font-normal text-red-500">Zamietnutý</td>
                           <td class="p-4 whitespace-nowrap text-center space-x-2">
                              <button type="button" data-modal-toggle="user-modal" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                 <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path>
    ...
    <!-- Paggination -->
      <div class="bg-white sticky flex items-center justify-center w-full bottom-0 right-0 border-t border-gray-200 pt-4">
         <div class="flex items-center mb-4 sm:mb-0">
            ...
            <span class="text-sm font-normal text-gray-500">Zobrazené <span class="text-gray-900 font-semibold">1-20</span> zo <span class="text-gray-900 font-semibold">100</span></span>
         </div>
      </div>
    ...
    <footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 mt-4">
        <ul class="flex items-center flex-wrap mb-6 md:mb-0">
            <li><a href="#" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Všeobecné podmienky používania</a></li>
            <li><a href="#" class="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Cookie nastavenia</a></li>
